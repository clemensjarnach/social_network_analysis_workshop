...
subtitle: "Network Visualisation with R and igraph"
...
This tutorial walks through the fundamentals of network visualisation in R using the `igraph` package. We'll build a network incrementally, starting with isolated clusters and progressively adding connections, colour coding, and degree-based sizing.
...
The network now has:
- A complete triangle (nodes 1, 2, 3)
- A second cluster (nodes 4–8) with internal ties but no external connections
- 8 edges total
